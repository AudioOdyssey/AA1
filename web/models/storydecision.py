...
def __init__(self, story_id =0, loc_id = 0, sequence_num = 0, decision_id = 0, decision_name = "", transition = False, transition_loc_id = 0, hidden = False, locked = False, decision_description = "", show_event_id = 0, show_object_id = 0, locked_descr = "", aftermath_descr = "", cause_event = False, effect_event_id = 0, can_occur_once = False, is_locked_by_event_id = 0, locked_by_event_description = ""):
...
def dec_list(cls, story_id):
        ...
        with conn.cursor() as cur:
            ...
            for row in results:
                objs_list.append(cls(row[0], row[1], row[2], row[3], row[4], row[5], row[6], row[7], row[8], row[9], row[10], row[11], row[12], row[13], row[14], row[15], row[16], row[17], row[18], row[19], row[20]))
        conn.close()
        return decs_list
