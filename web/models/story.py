    ...
    def get(cls, story_id):
        ...
        with conn.cursor() as cur:
            ...
            if results is None:
                ...
                results["story_price"], results["author_paid"], result['genre'], results["length_of_story"], 
                results["number_of_location"], results["number_of_decisions"], results["story_in_store"], 
                results["story_verification_date"], results["name_of_verifier"], result['verification_status'], results["story_ratings"], 
